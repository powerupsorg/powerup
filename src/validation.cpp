...
#if defined(NDEBUG)
# error "Powerup cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Powerup Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Powerup: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
