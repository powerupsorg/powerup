...
{
    const char* pszTimestamp = "Made on November 29, 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("033384710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1638208155, 2000678469, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x462de7023f899e9f9636614969f08367a5199d26259d646c9002695ba7fe1720"));
        assert(genesis.hashMerkleRoot == uint256S("0x8fcb10bff13fbd386024dec37bff7556bce88100e0af4ae0b431b73008606fd1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("66.29.149.193", "66.29.149.193", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("poweruptools.com", "dnsseed.poweruptools.com"));
        //vSeeds.push_back(CDNSSeedData("poweruppool.org", "dnsseed.poweruppool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x462de7023f899e9f9636614969f08367a5199d26259d646c9002695ba7fe1720"))
        ...
        chainTxData = ChainTxData{
            ...
            1638208155, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1638208155, 245817, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x371dd75f769c05edd9685792dd5d718a5016bc18cdbb1980b06a8a13a4d47b1d"));
        assert(genesis.hashMerkleRoot == uint256S("0x8fcb10bff13fbd386024dec37bff7556bce88100e0af4ae0b431b73008606fd1"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("66.29.149.193", "66.29.149.193"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.powerup.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x371dd75f769c05edd9685792dd5d718a5016bc18cdbb1980b06a8a13a4d47b1d")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1638208155, 0, 0x207fffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x93b9b846d2c83b4d36d346f76adc48f571b45b69722cde31245f90d2cac8dd89"));
        assert(genesis.hashMerkleRoot == uint256S("0x8fcb10bff13fbd386024dec37bff7556bce88100e0af4ae0b431b73008606fd1"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x93b9b846d2c83b4d36d346f76adc48f571b45b69722cde31245f90d2cac8dd89"))
        };
