...
const char * const BITCOIN_CONF_FILENAME = "powerup.conf";
const char * const BITCOIN_PID_FILENAME = "powerup.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Powerup";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Powerup";
#else
    // Unix
    return pathRet / ".powerup";
#endif
#endif
}
