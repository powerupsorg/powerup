...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s powerup-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  powerup-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded powerup transaction") + "\n" +
              "  powerup-tx [options] -create [commands]   " + _("Create hex-encoded powerup transaction") + "\n" +
              "\n";
